...
(function () {
    ...
    const TEMPLATES = [
        ...
        C({ id: 'mongrel', name: 'Дворняга', bookLevel: 3, bump: 'body',
            body: 6, mind: 4, melee: 3, ranged: 0, other: 2, hp: 8, init: 10, def: 1,
            immune: ['rad'], dr: { phys: 0, energy: 0, rad: 99, tox: 0 },
            attacks: [{ name: 'Укус', skill: 'melee', dmg: 4, extra: 'Физический' }],
            traits: ['Агрессивный', 'Дикий'] }),
    ...
    const PERCEPTION = 'Одно или несколько чувств обострены: может заметить то, что другие не видят, и снижает сложность остальных проверок на ВОС на 1 (минимум 0).';
    const AQUATIC = 'Умеет плавать и погружаться без необходимости всплывать. Атаки и движение под водой без повышения сложности.';
    const AGGRESSIVE = 'При появлении в сцене сразу 1 ОД: союзник — в пул группы, враг — в пул ГМа.';
    const FACE_SPOT = 'Панцирь прочный, морда — слабое место. В морду трудно попасть: защита 2.';
    const WILD = 'Неразумен, им движет звериный инстинкт. Красноречием не убедить. Стремится к ближайшему врагу; если врага нет — к яркому свету или громкому шуму, иначе бродит или лежит.';

    const BESTIARY_EXTRA = {
        bloodbug: {
            keywords: 'Мутировавшее насекомое',
            lore: 'Мутировавший комар: стаями у застойной воды и падали. Взрослые около полуметра, хоботок пробивает часть брони. Обычно плюют облучённой кровью, чтобы ослепить, затем прокалывают жертву и пьют кровь. Часто нападают на браминов, домашний скот и неосторожных путников.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса гнуса и 1 необычный материал.',
            abilities: []
        },
        bloatfly: {
            keywords: 'Мутировавшее насекомое',
            lore: 'Довоенная муха, раздутая радиацией: пестрый зелёно-коричневый панцирь. Стаями до четырёх особей стреляют личинками-дротиками из брюшка, преследуют добычу крупнее себя. Часто рядом с гнусами и жалокрылами у воды или падали.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса дутня и 1 необычный материал.',
            abilities: []
        },
        brahmin: {
            keywords: 'Мутировавшее млекопитающее',
            lore: 'Самый обычный скот пустоши: две головы и крупное вымя. Дают молоко, мясо и шкуру. Дикие бродят небольшими стадами; чаще их держат в хозяйствах или гоняют как вьючных. Крепкие, выносливые и в целом послушные.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса брамина и 2 необычных материала.',
            abilities: []
        },
        deathclaw: {
            keywords: 'Мутировавшая рептилия',
            lore: 'Генно-инженерный хищник на замену солдатам: гены хамелеона Джексона, когти, рога, рост выше человека и скорость не по размеру. Самки крупнее и яростно стерегут яйца. Одиночка уже опасен; гнездо почти всегда заканчивается быстрой смертью.',
            butcher: 'ВЫН + Выживание, сложность 1: 2 порции мяса когтя смерти.',
            traits: ['Обострённое восприятие', 'Раздирание', 'Уязвимое место', 'Огромная сила'],
            extraAttacks: [
                { name: 'Толчок', skill: 'melee', dmg: 4, extra: 'Оглушающий, физ.' },
                { name: 'Тяжёлый объект', skill: 'ranged', attr: 'body', dmg: 4, extra: 'Оглушающий, физ., метательное, дист. С' }
            ],
            abilities: [
                { name: 'Обострённое восприятие', text: PERCEPTION },
                { name: 'Раздирание', text: 'Может выбрать более смертоносную атаку когтями: +1 к сложности. При успехе урон атаки +2.' },
                { name: 'Уязвимое место', text: 'Если атакующий выбирает целью торс, игнорирует СУ тела. Не относится к случайным попаданиям в торс.' },
                { name: 'Огромная сила', text: 'Способен поднимать и бросать предметы размером с легковой автомобиль.' }
            ]
        },
        dog: {
            keywords: 'Млекопитающее',
            lore: 'Одни из немногих животных, не мутировавших как вид. В поселениях — домашние и сторожевые, с тем же умом и повадками, что у довоенных предков.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса собаки.',
            abilities: [
                { name: 'Острые чувства', text: PERCEPTION }
            ]
        },
        mongrel: {
            keywords: 'Мутировавшее млекопитающее',
            lore: 'Стаи бешеных облучённых псов. Дружелюбные мутанты редки: обычно рвут добычу. Шерсть клочьями или вовсе нет, кожа почти как у гуля.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса собаки.',
            traits: ['Обострённое восприятие'],
            abilities: [
                { name: 'Агрессивный', text: AGGRESSIVE },
                { name: 'Обострённое восприятие', text: PERCEPTION },
                { name: 'Одичалый', text: WILD }
            ]
        },
        'mirelurk-hatchling': {
            keywords: 'Мутировавшее ракообразное',
            lore: 'Молодые болотники. Яйца кладут в защищённое гнездо; потревоженные могут вылупиться сразу. Одиночную кладку грамотный боец берёт легко, если яиц не слишком много. Панцирь ещё мягкий, размер примерно с радтаракана.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса болотника.',
            traits: ['Водоплавающий'],
            abilities: [
                { name: 'Водоплавающий', text: AQUATIC }
            ]
        },
        mirelurk: {
            keywords: 'Мутировавшее ракообразное',
            lore: 'Самый частый болотник: похож на мечехвоста, клешни ломают кости. Держится группами у больших водоёмов. На панцире иногда моллюски, сети или мусор — так их проще заметить.',
            butcher: 'ВЫН + Выживание, сложность 0: 2 порции мяса болотника. Каждый выпавший эффект — ещё 1 мясо болотника с мягким панцирем.',
            traits: ['Водоплавающий'],
            abilities: [
                { name: 'Маленькое уязвимое место', text: FACE_SPOT },
                { name: 'Водоплавающий', text: AQUATIC }
            ]
        },
        'mirelurk-hunter': {
            keywords: 'Мутировавшее ракообразное',
            lore: 'Похоже, произошли от омаров, а не крабов: удлинённое тело и хвост. Клешни мощные, характер злее. Панцирь крепче, умеют выплёвывать кислоту — в блоке атак этой струи нет, только клешни.',
            butcher: 'ВЫН + Выживание, сложность 0: 2 порции мяса болотника. Каждый выпавший эффект — ещё 1 мясо болотника с мягким панцирем.',
            traits: ['Водоплавающий'],
            abilities: [
                { name: 'Маленькое уязвимое место', text: FACE_SPOT },
        ...
        'mirelurk-queen': {
            keywords: 'Мутировавшее ракообразное',
            lore: 'Редкая крабоподобная матка: выше прочих болотников, часть размером с бегемота. Агрессивны, плюются кислотой и насылают личинок. Панцирь почти непробиваем, мягкая морда — слабое место. Яростно стерегут гнёзда; перед атакой поднимают рокочущий рёв.',
            butcher: 'ВЫН + Выживание, сложность 0: 5 порций мяса матки болотников.',
            salvage: 'Среди останков и в логове: 4d20 крышек; бросок 4 — за каждый эффект один бросок по таблице случайного хлама. По решению ГМ — до трёх единиц оружия и 3d20 патронов к ним.',
            traits: ['Водоплавающий', 'Призыв личинок', 'Иммунитет к страху', 'Агрессивный', 'Панцирь: слабое место — лицо'],
            extraAttacks: [
                { name: 'Струя кислоты', skill: 'melee', dmg: 10, extra: 'Проникающий, радиоактивный' }
            ],
            patchAttacks: [
                { name: 'Клешни', extra: 'Жестокий' }
            ],
            abilities: [
                { name: 'Маленькое уязвимое место', text: FACE_SPOT },
                { name: 'Водоплавающий', text: AQUATIC },
                { name: 'Призыв личинок', text: 'Раз в раунд ГМ может потратить 4 ОД как основное действие и выпустить 4 личинок болотника. В этот раунд матка не атакует основным действием.' },
                { name: 'Иммунитет к страху', text: 'Её нельзя запугать или принудить угрозой: игнорирует запугивание или атакует того, кто пытается.' },
                { name: 'Агрессивный', text: AGGRESSIVE }
            ]
        },
        molerat: {
            keywords: 'Мутировавшее млекопитающее',
            lore: 'Мутировавший голый землекоп размером с собаку. Норы под землёй прячут от хищников. Живут и охотятся стаями, зарываются для засады или бегства. Передние зубы огромные, бросок быстрый. Обычно дикие, но некоторых дрессируют как собак.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса кротокрыса и 1 обычный материал.',
            traits: ['Зарывается', 'Обострённое восприятие'],
            patchAttacks: [
                { name: 'Укус', extra: 'Проникающий' }
            ],
            abilities: [
                { name: 'Зарывается', text: 'Основным действием зарывается. На следующий ход второстепенным появляется в пределах средней дистанции от точки. За 1 ОД может добавить кубик к укусу после появления.' },
                { name: 'Обострённое восприятие', text: PERCEPTION }
            ]
        },
        mutt: {
            keywords: 'Мутировавшее млекопитающее',
            lore: 'Не облучённая дворняга, а существо вируса принудительной эволюции: в несколько раз крупнее собаки, мышцы и агрессия выше, интеллект не снижен как у супермутантов. Кожа часто зелёная, без шерсти. Почти всегда рядом с супермутантами — сторожевые или компаньоны.',
            butcher: 'ВЫН + Выживание, сложность 1: 1 порция мяса гончей-мутанта, +1 за каждое потраченное ОД. Эффект — 1 обычный материал.',
            traits: ['Предупредительный вой', 'Обострённое восприятие'],
            abilities: [
                { name: 'Обострённое восприятие', text: PERCEPTION },
                { name: 'Предупредительный вой', text: 'В первом раунде может завыть основным действием. Каждый супермутант или гончая-мутант в зоне действия получает дополнительное второстепенное действие на следующий ход. Один раз за бой на NPC.' }
            ]
        },
        radroach: {
            keywords: 'Мутировавшее насекомое',
            lore: 'Довоенные тараканы, только крупнее: живут в руинах, кучах мусора и сырых тёмных углах. Прыгают на жертву и рвут клешнями. Поодиночке слабы, стаей забивают неподготовленных и опустошают поселения.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса радтаракана.',
            traits: ['Скрытный'],
            abilities: [
                { name: 'Скрытный', text: 'ЗУ 10 на проверки Скрытности, +1d20 при скрытной атаке.' }
            ]
        },
        radscorpion: {
            keywords: 'Мутировавший арахнид',
            lore: 'Императорский скорпион, выросший почти до автомобиля. Панцирь, клешни, жало и скорость; крупные особи спорят с когтями смерти. Яд жала валит крупную добычу или человека в броне за один-два удачных укола. Зарываются и бьют из засады.',
            butcher: 'ВЫН + Выживание, сложность 1: 2 порции мяса радскорпиона. Эффект — 1 редкий материал; два эффекта — яйцо радскорпиона.',
            traits: ['Уязвимое место', 'Зарывается'],
            extraAttacks: [
                { name: 'Жало', skill: 'melee', dmg: 3, extra: 'Продолжительный (токсический)' }
            ],
            abilities: [
                { name: 'Уязвимое место', text: 'Если атакующий выбирает целью голову, игнорирует СУ головы. Не относится к случайным попаданиям в голову.' },
                { name: 'Зарывается', text: 'Основным действием уходит под землю: невидим и его нельзя атаковать. Основным прорывает две зоны под полем. Выбраться — второстепенное действие. Не проходит сквозь камень, металл или дерево.' }
            ]
        },
        radstag: {
            keywords: 'Мутировавшее млекопитающее',
            lore: 'Потомок оленя с двумя головами: у каждой по одному слепому глазу, ориентируются вместе, головы двигаются раздельно. С груди свисают две лишние ноги — сгибаются, когда ложится, иначе бесполезны. Шерсть часто лишайная, у бешеных сходит. Ходят стадами, спокойны, пока им не угрожают.',
            butcher: 'ВЫН + Выживание, сложность 0: 2 порции мяса рад-оленя. Эффект — шкура рад-оленя.',
            abilities: []
        },
        stingwing: {
            keywords: 'Мутировавшее насекомое',
            lore: 'Мутировавшая скорпионья муха. Гнездятся там же, где дутни и гнусы. Ядовитое жало, очень быстры, пикируют на жертву. Гнёзда на земле и на высоте, их выдаёт ярко-жёлтая медовая жижа. Потревоженный рой поднимается защищать кладку.',
            butcher: 'ВЫН + Выживание, сложность 0: 1 порция мяса жалокрыла.',
            traits: ['Пикирующая бомба'],
            abilities: [
                { name: 'Пикирующая бомба', text: 'Если в тот же ход перемещается в зону досягаемости и бьёт в ближнем бою, может перебросить 1d20 атаки. После удара может потратить 1 ОД, чтобы сместиться на одну зону.' }
            ]
        },
        yaoguai: {
            keywords: 'Мутировавшее млекопитающее',
            lore: 'То, что осталось от медведей после войны: длинные когти, больше мышц, мощный укус. Территориальны, защищают потомство и стаю. Известны случаи нападения даже на когтей смерти, зашедших на их землю.',
            butcher: 'ВЫН + Выживание, сложность 1: 2 порции мяса яо-гуай. Эффект — ещё 2 обычных материала.',
            extraAttacks: [
                { name: 'Укус', skill: 'melee', dmg: 10, extra: 'Проникающий, физ.' }
            ],
            abilities: [
                { name: 'Агрессивный', text: AGGRESSIVE }
            ]
    ...
    function applyBestiaryExtra() {
        TEMPLATES.forEach(t => {
            const x = BESTIARY_EXTRA[t.id];
            if (!x) return;
            if (x.keywords) t.keywords = x.keywords;
            if (x.lore) t.lore = x.lore;
            if (x.butcher) t.butcher = x.butcher;
            if (x.salvage) t.salvage = x.salvage;
            if (x.abilities && x.abilities.length) t.abilities = x.abilities.slice();
            if (x.traits && x.traits.length) {
                t.traits = t.traits || [];
                x.traits.forEach(tr => {
                    if (t.traits.indexOf(tr) < 0) t.traits.push(tr);
                });
            }
            if (x.extraAttacks && x.extraAttacks.length) {
                t.attacks = t.attacks || [];
                x.extraAttacks.forEach(a => {
                    if (!(t.attacks || []).some(ex => ex.name === a.name)) t.attacks.push(a);
                });
            }
            (x.patchAttacks || []).forEach(p => {
                const a = (t.attacks || []).find(at => at.name === p.name);
                if (!a || !p.extra) return;
                if (String(a.extra || '').indexOf(p.extra) < 0) {
                    a.extra = a.extra ? a.extra + ', ' + p.extra : p.extra;
                }
            });
        });
    }
    ...
    function creatureAttacks(src, deltaLv, body, mind) {
        return (src.attacks || []).map(a => {
            ...
            const attr = a.attr === 'body' ? body
                : a.attr === 'mind' ? mind
                : (a.skill === 'ranged' || a.skill === 'other' ? mind : body);
    ...
    function generate(templateId, level, rank) {
        ...
        const foe = {
            ...
            butcher: src.butcher || '',
            salvage: src.salvage || '',
            abilities: (src.abilities || []).map(a => ({ name: a.name, text: a.text }))
        };
    ...
    function fillNpcDrawer() {
        ...
        const abilities = (f.abilities || []).map(a =>
            '<div class="npc-ability"><b>' + esc(a.name) + '</b>' + esc(a.text || '') + '</div>'
        ).join('');
        const abilBlock = abilities
            ? '<div class="enc-block"><div class="enc-block-title">Особенности</div>' + abilities + '</div>' : '';
        const salvageBlock = f.salvage
            ? '<div class="enc-block"><div class="enc-block-title">Обыск</div><div class="enc-block-text">' + esc(f.salvage) + '</div></div>' : '';
        const butcherBlock = f.butcher
            ? '<div class="enc-block"><div class="enc-block-title">Потрошение</div><div class="enc-block-text">' + esc(f.butcher) + '</div></div>' : '';
        const loreBlock = f.lore
            ? '<div class="enc-block"><div class="enc-block-title">Описание</div><div class="enc-block-text npc-lore">' + esc(f.lore) + '</div></div>' : '';
        body.innerHTML = '<div class="npc-sheet">' +
            '<div class="npc-sheet-meta">Ур. ' + f.level + ' · ' + esc(rankLabel(f.rank, f.kind)) + ' · ' + f.xp + ' XP' +
            (f.keywords ? ' · ' + esc(f.keywords) : '') + '</div>' +
            hpBlock(gid, fid, f) +
            stats +
            ...
            salvageBlock + butcherBlock + loreBlock +
