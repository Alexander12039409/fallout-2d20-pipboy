...
(function () {
    ...
    const ORIGINS = [
        ...
        {
            id: 'Братство Стали',
            icon: 'origin/Братство стали.svg',
        ...
        },
        {
            ...
            mechanic: 'СИЛ и ВЫН стартуют с 7, максимум 12. ИНТ и ХАР максимум 6. Навыки не выше 4. Только рейдерская броня (нагрудник, шлем, наруч или понож). Одежду носить нельзя.',
            maxLine: 'СИЛ/ВЫН ≤ 12 · ИНТ/ХАР ≤ 6 · остальные ≤ 10'
        },
        {
            id: 'Мистер Помощник',
            icon: 'origin/Мистер помощник.svg',
            ...
            mechanic: 'Робот: 360° сенсоры, иммунитет к радиации и яду. Не ест, не пьёт химию, не лечится отдыхом — только ремонт. Носит только обшивку робота. Груз 150 фунтов (в книге 70 кг).',
            maxLine: 'Все атрибуты ≤ 10'
        },
        {
            id: 'Выходец из Убежища',
            icon: 'origin/Выходец из убежища.svg',
    ...
    function renderOrigin() {
        const cards = ORIGINS.map(o => {
            ...
            return '<button type="button" class="chargen-origin-card' + on + '" data-origin="' + htmlEsc(o.id) + '">' +
                '<div class="chargen-origin-icon">' + glyph((typeof originIconRel === 'function' ? originIconRel(o.id) : o.icon)) + '</div>' +
